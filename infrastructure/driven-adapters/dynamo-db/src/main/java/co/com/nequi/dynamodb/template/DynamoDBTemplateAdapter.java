package co.com.nequi.dynamodb.template;
...
@Repository
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<User /*domain model*/, String, ModelEntity /*adapter model*/> /* implements Gateway from domain */ {
    ...
    public DynamoDBTemplateAdapter(DynamoDbEnhancedAsyncClient connectionFactory, ObjectMapper mapper) {
         ...
         */
        super(connectionFactory, mapper, d -> mapper.map(d, User.class), "tallerNequiUsers");
    }
